...
Public Class Form1
    ...
    Function cekDataBuku(x As String)
        Dim MyCommand As New MySqlCommand
        Dim MyAdapter As New MySqlDataAdapter
        Dim MyData As New DataTable
        Dim rdr As MySqlDataReader
        Dim setBuku As New ArrayList
        ...
        Try
            ...
            Sql = "Select KodeBuku From databuku;"

            MyCommand.Connection = conn
            MyCommand.CommandText = Sql
            rdr = MyCommand.ExecuteReader()
            While rdr.Read()
                setBuku.Add(rdr.Item("KodeBuku"))
            End While

            For Each I As String In setBuku
                If I = x Then
                    Exit For
                    Return True
                End If
